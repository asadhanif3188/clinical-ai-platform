...
def test_common_schemas():
    ...
    round_trip(
        ...
        {"items": [1, 2, 3], "total": 3, "page": 1, "page_size": 10, "pages": 1},
    )
...
def test_memory_schemas():
    ...
    round_trip(
        MemorySearchResult, {"entry_id": uuid4(), "content": "c", "score": 0.5, "metadata": {}}
    )
...
def test_pharma_schemas():
    ...
    round_trip(
        NormalizedMedication, {"rxcui": "1", "name": "n", "standard_name": "s", "confidence": 1.0}
    )
    round_trip(
        DrugInteraction, {"drug_a": "a", "drug_b": "b", "severity": InteractionSeverity.HIGH}
    )
    round_trip(
        RiskAssessmentReport,
        {
