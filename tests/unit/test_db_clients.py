...
from clinical_ai_shared.db.postgres import get_async_session, init_db, close_db
from clinical_ai_shared.db.pgvector import embed_and_store, search, delete, init_vector_db, close_vector_db
from clinical_ai_shared.db.neo4j import execute_query, close_driver
from clinical_ai_shared.db.redis import cache_set, cache_get, publish, close_redis
...
async def test_pgvector_embed_and_store():
    with patch("clinical_ai_shared.db.pgvector.get_embedding_model") as mock_get_model, \
