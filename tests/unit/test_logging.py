...
import uuid
import structlog
from clinical_ai_shared.observability.logging import get_logger, set_correlation_id, configure_logging
...
def test_logger_correlation_id(monkeypatch):
    ...
    structlog.configure(
        ...
        processors=[
            ...
            lambda _l, _m, event_dict: {**event_dict, "correlation_id": "test-id"} if "correlation_id" not in event_dict else event_dict,
