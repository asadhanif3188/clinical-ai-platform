...
from clinical_ai_shared.schemas.common import ProvenanceRecord
...
class DocumentInput(BaseModel):
    ...
    phi_sensitive: bool = Field(
        False, description="If True, document contains PHI and must stay local"
    )
...
class ExtractionResult(BaseModel):
    ...
    provenance: list[ProvenanceRecord] = Field(
        ..., description="Source location for extracted data"
    )
    model_used: str
